...
class _AddressState extends State<Address> {
  ...
  onAddressSwitch(index) async {
    ...
    if (addressMakeDefaultResponse.result == false) {
      ToastComponent.showDialog(addressMakeDefaultResponse.message, gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
  ...
  confirmDelete(id) async {
    ...
    if (addressDeleteResponse.result == false) {
      ToastComponent.showDialog(addressDeleteResponse.message, gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
  ...
  onAddressAdd(context) async {
    ...
    if (address == "") {
      ToastComponent.showDialog(
          AppLocalizations.of(context).address_screen_address_warning, gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }

    if (_selected_country == null) {
      ToastComponent.showDialog(
          AppLocalizations.of(context).address_screen_country_warning, gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }

    if (_selected_state == null) {
      ToastComponent.showDialog(
          AppLocalizations.of(context).address_screen_state_warning, gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }

    if (_selected_city == null) {
      ToastComponent.showDialog(
          AppLocalizations.of(context).address_screen_city_warning, gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
    ...
    if (addressAddResponse.result == false) {
      ToastComponent.showDialog(addressAddResponse.message, gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
  ...
  onAddressUpdate(context, index, id) async {
    ...
    if (addressUpdateResponse.result == false) {
      ToastComponent.showDialog(addressUpdateResponse.message, gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
