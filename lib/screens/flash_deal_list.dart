...
import 'package:Samimi/screens/flash_deal_products.dart';
import 'package:Samimi/repositories/flash_deal_repository.dart';
      ...
      child: CountdownTimer(
        ...
        widgetBuilder: (_, CurrentRemainingTime time) {
          return GestureDetector(
            onTap: () {
              if (time == null) {
                ToastComponent.showDialog(AppLocalizations.of(context).flash_deal_list_screen_flash_deal_has_ended, gravity: Toast.center, duration: Toast.lengthLong);
              } else {
