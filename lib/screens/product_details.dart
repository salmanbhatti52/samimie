...
import 'package:Samimi/screens/common_webview_screen.dart';
import 'package:Samimi/screens/login.dart';
import 'package:Samimi/screens/product_reviews.dart';
import 'package:Samimi/ui_elements/list_product_card.dart';
import 'package:Samimi/ui_elements/mini_product_card.dart';
...
import 'package:Samimi/repositories/product_repository.dart';
import 'package:Samimi/repositories/wishlist_repository.dart';
import 'package:Samimi/repositories/cart_repository.dart';
import 'package:Samimi/app_config.dart';
import 'package:Samimi/helpers/shimmer_helper.dart';
import 'package:Samimi/helpers/color_helper.dart';
...
import 'dart:async';
import 'package:Samimi/screens/video_description_screen.dart';
...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  onWishTap() {
    if (is_logged_in.$ == false) {
      ToastComponent.showDialog(AppLocalizations.of(context).common_login_warning, gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
  ...
  addToCart({mode, context = null, snackbar = null}) async {
    ...
    if (cartAddResponse.result == false) {
      ToastComponent.showDialog(cartAddResponse.message, gravity: Toast.center, duration: Toast.lengthLong);
      return;
    } else {
      if (mode == "add_to_cart") {
  ...
  onPressSendMessage() async {
    ...
    if (title == "" || message == "") {
      ToastComponent.showDialog(AppLocalizations.of(context).product_details_screen_seller_chat_title_message_empty_warning, gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
    ...
    if (conversationCreateResponse.result == false) {
      ToastComponent.showDialog(AppLocalizations.of(context).product_details_screen_seller_chat_creation_unable_warning, gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
                      ...
                      onTap: () {
                        if (_productDetails.video_link == "") {
                          ToastComponent.showDialog(
                              AppLocalizations.of(context).product_details_screen_video_not_available,gravity: Toast.center,
